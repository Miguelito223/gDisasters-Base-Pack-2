function gDisasters_PostSpawnSH()
    local function gDisasters_SetupConvars()
		...
		CreateConVar( "gdisasters_heat_system_updatebatchsize", "500", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_updateinterval", "1", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_tempdifussioncoefficient", "0.01", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_humiditydifussioncoefficient", "0.01", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_solarinfluencecoefficient", "0.1", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_windcoefficient", "0.1", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_clouddensitycoefficient", "0.05", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_convergencecoefficient", "0.05", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_terraincoefficient", "0.1", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_latentheatcoefficient", "0.1", {FCVAR_ARCHIVE}, "")
		CreateConVar( "gdisasters_heat_system_coolingcoefficient", "0.1", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_gridsize", "5000", {FCVAR_ARCHIVE}, "" )
		...
		CreateConVar( "gdisasters_heat_system_maxwind", "10000", {FCVAR_ARCHIVE}, "" )
		...
		CreateConVar( "gdisasters_heat_system_minwind", "0", {FCVAR_ARCHIVE}, "" )
		--dnc
        ...
        CreateConVar( "gdisasters_dnc_create_light_environment", "1", {FCVAR_ARCHIVE}, "" )
