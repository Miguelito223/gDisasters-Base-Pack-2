function gDisasters_PostSpawnSH()
    local function gDisasters_SetupConvars()
		...
		CreateConVar( "gdisasters_heat_system_solarinfluencecoefficient", "0.01", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_airflowcoefficient", "0.01", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_clouddensitycoefficient", "0.01", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_convergencecoefficient", "0.01", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_terraincoefficient", "0.01", {FCVAR_ARCHIVE}, "" )
		CreateConVar( "gdisasters_heat_system_coolingcoefficient", "0.01", {FCVAR_ARCHIVE}, "" )
