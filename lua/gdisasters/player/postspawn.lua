...
function gDisasters_PostSpawnCL()
	...
	local function gDisasters_SetupHUDConvars()
		...
		CreateConVar( "gdisasters_antilag_ground_particles", 1, {FCVAR_ARCHIVE}, "")
		CreateConVar( "gdisasters_antilag_weather_particles", 1, {FCVAR_ARCHIVE}, "")
		CreateConVar( "gdisasters_antilag_number_of_passes", 1, {FCVAR_ARCHIVE}, "")
