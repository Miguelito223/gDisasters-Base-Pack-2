...
local function gDisastersHeatSystemBeta( CPanel )
	...
	CreateSliderConVariable(CPanel, "Latent Heat Coeficcient", 0, 1, 2, "gdisasters_heat_system_latentheatcoefficient" )
	CreateSliderConVariable(CPanel, "wind Coeficcient", 0, 1, 2, "gdisasters_heat_system_windcoefficient" )
	...
	CreateSliderConVariable(CPanel, "Max Temp", -273, 273, 1, "gdisasters_heat_system_maxtemp" )
	...
	CreateSliderConVariable(CPanel, "Max wind", 0, 100000, 0, "gdisasters_heat_system_maxwind" )
	...
	CreateSliderConVariable(CPanel, "Min wind", 0, 100000, 0, "gdisasters_heat_system_minwind" )
