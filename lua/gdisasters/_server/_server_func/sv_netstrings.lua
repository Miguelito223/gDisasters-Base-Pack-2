...
util.AddNetworkString( "gd_stopsound" )
util.AddNetworkString( "gd_ambientlight"	)
util.AddNetworkString( "gd_shakescreen"	)
util.AddNetworkString( "gd_soundwave" )
util.AddNetworkString( "gd_soundwave_stop")
util.AddNetworkString( "gd_WeatherChange" )
util.AddNetworkString( "gd_UpdateTemperature" )
util.AddNetworkString( "gd_UpdateWeather" )
