...
MAP_BOUNDS["gm_construct"]				  = { Vector(1869, -3696, -555),        Vector(-5247, 6471, 9932),          Vector(0,0,-162)		}
...
MAP_BOUNDS["gm_flatgrass"] 				  = { Vector(15343,15343,-13110),       Vector(-15343,-15343, 15359), 	    Vector(0,0,-12806)		}
...
MAP_BOUNDS["gm_flatgrass_water"]     = { Vector(-8096, -11509, -896),  		Vector(8507, 11556, -896),				Vector(0,0,-895)       }
MAP_BOUNDS["gm_flatgrass_water_v2"]     = { Vector(-8096, -11509, -896),  		Vector(8507, 11556, -896),				Vector(0,0,-1015)       }
