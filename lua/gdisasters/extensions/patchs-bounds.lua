...
MAP_BOUNDS["gm_bigcity"] 				  = { Vector(13172, 13171, -11075),     Vector(-13033, -13164, -11075),       Vector(0,0,-11075)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_improved_lite"] 				  = { Vector(13172, 13171, -11075),     Vector(-13033, -13164, -11075),       Vector(0,0,-11075)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_d"] 				  = { Vector(13172, 13171, -11075), 	Vector(-13033, -13164, -11075),       Vector(0,0,-11075)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_improved"] 		  = { Vector(13172, 13171, -11075),     Vector(-13033, -13164, -11075),       Vector(0,0,-11075)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_sunset"] 		  = { Vector(13172, 13171, -11075), 	Vector(-13033, -13164, -11075),       Vector(0,0,-11075)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_winter"] 		  = { Vector(13172, 13171, -11075),     Vector(-13033, -13164, -11075),       Vector(0,0,-11075)      } --fix duplicate
...
MAP_BOUNDS["gm_buttes2"]	  	          = { Vector(16238,16240,-13119),		Vector(-16077,-15983,-13119),		Vector(0,0,-13119)		}
...
MAP_BOUNDS["gm_flatgrass_classic_noded"]     = { Vector(-3678.1, -72.8, -1),  		Vector(-6761.1, -493.6, -1),				Vector(0,0,0)       }
MAP_BOUNDS["gm_flatgrass_classic_remade"]     = { Vector(7088.5, -382.3, 128),  		Vector(13222.9, -500.4, 128),				Vector(0,0,0)       }
MAP_BOUNDS["gm_flatgrass_night_exp"]     = { Vector(11187.1, -89.5, -12800),  		Vector(12846.4, -2918.6, -12800),				Vector(0,0,0)       }
MAP_BOUNDS["gm_flatgrass_water"]     = { Vector(-8096, -11509, -896),  		Vector(8507, 11556, -896.066101),				Vector(0,0,-895)       }
MAP_BOUNDS["gm_flatgrass_water_v2"]     = { Vector(-8096, -11509, -895),  		Vector(8507, 11556, -895),				Vector(0,0,-895)       }
