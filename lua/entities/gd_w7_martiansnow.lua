...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(50,95),["Direction"]=Vector(1,0,0)}, ["Pressure"]    = 96000, ["Temperature"] = -100, ["Humidity"]    = math.random(10,45), ["BRadiation"]  = 100, ["Oxygen"]  = 100}}
