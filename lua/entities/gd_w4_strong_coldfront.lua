...
function ENT:Squall()
	GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(75,89),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 49000, ["Temperature"] = math.random(7,12), ["Humidity"]    = math.random(45,49), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:Passage()
	...
	GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(130,148),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 26000, ["Temperature"] = math.random(2,5), ["Humidity"]    = math.random(95,97), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:AfterFront()
    ...
    GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(45,67),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 126000, ["Temperature"] = math.random(3,5), ["Humidity"]    = math.random(67,89), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
