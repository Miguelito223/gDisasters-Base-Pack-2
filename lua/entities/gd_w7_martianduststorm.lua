...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(230,255) ,["Direction"]=Vector(0,-1,0)}, ["Pressure"]    = 101000, ["Temperature"] = math.random(42), ["Humidity"]    = math.random(5,15), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
