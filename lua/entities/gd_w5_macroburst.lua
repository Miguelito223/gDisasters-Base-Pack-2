...
function ENT:HeavyRaining()
	...
	GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(210,257),["Direction"]=Vector(0,1,0)}, ["Pressure"]    = 45000, ["Temperature"] = math.random(4,8), ["Humidity"]    = math.random(97,99), ["BRadiation"]  = 0.1}}
