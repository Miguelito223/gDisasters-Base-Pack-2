...
function ENT:Lightning()
	...
	if !self:IsValid() then return end
		local ent = ents.Create("gd_w4_derecho_cl")
		ent:SetPos(pos)
		ent:Spawn()
		ent:Activate()
...
function ENT:ClearSky()
	GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(2,6),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 78000, ["Temperature"] = math.random(28,31), ["Humidity"]    = math.random(34,40), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:Squall()
	GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(26,33),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 49000, ["Temperature"] = math.random(17,20), ["Humidity"]    = math.random(45,49), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:Passage()
	...
	GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(130,148),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 26000, ["Temperature"] = math.random(7,15), ["Humidity"]    = math.random(95,97), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:AfterFront()
    ...
    GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(4,12),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 126000, ["Temperature"] = math.random(3,5), ["Humidity"]    = math.random(67,89), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:OnRemove()
	...
	if (SERVER) then		
		...
		for k, v in pairs(ents.FindByClass("gd_w4_derecho_cl")) do v:Remove() end
