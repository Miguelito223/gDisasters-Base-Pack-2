...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=0,["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 96000, ["Temperature"] = math.random(5,10), ["Humidity"]    = math.random(25,45), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
