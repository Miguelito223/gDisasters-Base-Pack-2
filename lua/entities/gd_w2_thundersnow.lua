...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(35,50),["Direction"]=Vector(1,0,0)}, ["Pressure"]    = 93500, ["Temperature"] = math.random(-8,-2), ["Humidity"]    = math.random(45,67), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
