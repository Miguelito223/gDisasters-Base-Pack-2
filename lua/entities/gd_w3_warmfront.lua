...
function ENT:PassageHigh()
	GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(14,17),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 124000, ["Temperature"] = math.random(32,36), ["Humidity"]    = math.random(41,46), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:PassageLow()
	...
	GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(24,32),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 16000, ["Temperature"] = math.random(15,16), ["Humidity"]    = math.random(73,81), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
