...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(80,125),["Direction"]=Vector(0,1,0)}, ["Pressure"]    = 96000, ["Temperature"] = math.random(10,20), ["Humidity"]    = math.random(20,65), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
