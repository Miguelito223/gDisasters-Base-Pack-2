...
function ENT:Think()
	if (SERVER) then 
		...
		for k, v in pairs(ents.FindByClass("gd_d11_neutron_star")) do 
		...
		for k, v in pairs(ents.FindByClass("gd_d9_meteorshower")) do 
		...
		for k, v in pairs(ents.FindByClass("gd_d7_lavabombshower")) do 
