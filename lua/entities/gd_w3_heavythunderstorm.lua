...
ENT.PrintName		                 =  "Heavy Thundestorm"
ENT.Author			                 =  "Hmm"
ENT.Contact		                     =  "Hmm"
ENT.Category                         =  "Hmm"
...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(32,39),["Direction"]=Vector(-1,0,0)}, ["Pressure"]    = 95000, ["Temperature"] = math.random(15,18), ["Humidity"]    = math.random(40,80), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:Lightning()
	...
	if !self:IsValid() then return end
		local ent = ents.Create("gd_w3_heavythunderstorm_cl")
		ent:SetPos(pos)
		ent:Spawn()
		ent:Activate()
