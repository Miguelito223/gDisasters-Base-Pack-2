...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(1550,1650),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 10000, ["Temperature"] = math.random(-100,-176), ["Humidity"]    = math.random(0,0), ["BRadiation"]  = 0.1, ["Oxygen"] = 0}}
		...
		self.Original_SkyData["TopColor"]    = Vector(0.8, 0.8, 0.6)
		self.Original_SkyData["BottomColor"] = Vector(0.8, 0.8, 0.6)
		self.Original_SkyData["DuskScale"]   = 0
		self.Original_SkyData["SunScale"]   = 1.50
