...
function ENT:Erupt()
	...
	pe:SetKeyValue( "Magnitude", 1800 );
	pe:SetKeyValue( "radius", 2200 );
	...
	util.BlastDamage( self, self, self:GetLavaLevelPosition(), 1400, math.random( 10, 20 ) )
...
function ENT:SetLavaLevel(lvl)
	local lava_lvl  = math.Clamp(lvl, 0, 800)
	...
	elseif lava_lvl>=600 and lava_lvl<=700 then
		local diff = lava_lvl - 400
		
		self:ManipulateBonePosition( lava_level_main, Vector(0,0, 100  ))
		self:ManipulateBonePosition( lava_level_extension, Vector(0,40, 0  ))
		self:ManipulateBonePosition( lava_level_extension2, Vector(0,400, 0  ))
		self:ManipulateBonePosition( lava_level_extension3, Vector(0,100, 0  ))
		self:ManipulateBonePosition( lava_level_extension4, Vector(0,100, 0  ))
		self:ManipulateBonePosition( lava_level_extension5, Vector(0,diff, 0  ))
	elseif lava_lvl>700 and lava_lvl<=800 then
		local diff = lava_lvl - 400
		
		self:ManipulateBonePosition( lava_level_main, Vector(0,0, 100  ))
		self:ManipulateBonePosition( lava_level_extension, Vector(0,10, 0  ))
		self:ManipulateBonePosition( lava_level_extension2, Vector(0,400, 0  ))
		self:ManipulateBonePosition( lava_level_extension3, Vector(0,100, 0  ))
		self:ManipulateBonePosition( lava_level_extension4, Vector(0,100, 0  ))
		self:ManipulateBonePosition( lava_level_extension5, Vector(0,diff, 0  ))
