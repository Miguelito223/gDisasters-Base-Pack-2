...
function ENT:HeavyRaining()
	...
	GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(65,85),["Direction"]=Vector(0,1,0)}, ["Pressure"]    = 155000, ["Temperature"] = math.random(8,16), ["Humidity"]    = math.random(93,98), ["BRadiation"]  = 0.1}}
