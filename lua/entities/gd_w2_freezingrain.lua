...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(20,45),["Direction"]=Vector(-1,0,0)}, ["Pressure"]    = 60000, ["Temperature"] = math.random(-12, -6), ["Humidity"]    = math.random(35,50), ["BRadiation"]  = 0.1}}
