...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(15,35),["Direction"]=Vector(1,0,0)}, ["Pressure"]    = 101000, ["Temperature"] = math.random(35,45), ["Humidity"]    = math.random(1,15), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
